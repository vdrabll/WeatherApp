...
private extension WeatherView {
    func setupSubviews() {
        ...
        weatherLable.widthAnchor.constraint(equalToConstant: 92).isActive = true
        weatherLable.heightAnchor.constraint(equalToConstant: 70).isActive = true
        weatherLable.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 140).isActive = true
        weatherLable.topAnchor.constraint(equalTo: topAnchor, constant: 281).isActive = true
        ...
        weatherInfo.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 24).isActive = true
        weatherInfo.topAnchor.constraint(equalTo: topAnchor, constant: 466).isActive = true
    }
}
